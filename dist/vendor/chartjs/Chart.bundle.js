                ...
                if (
                  ...
                  for (var i = 0; i < datasetIndex; i++) {
                    ...
                    if (
                      ...
                      base +=
                        value < 0
                          ? Math.min(currentVal, original)
                          : Math.max(currentVal, original);
                    }
                  }
                ...
                if (
                  ...
                  for (var i = 0; i < datasetIndex; i++) {
                    ...
                    if (
                      ...
                      base +=
                        value < 0
                          ? Math.min(currentVal, originalBase)
                          : Math.max(currentVal, originalBase);
                    }
                  }
            ...
            helpers.extend(
              ...
              /** @lends Chart.Controller.prototype */ {
                ...
                resize: function (silent) {
                  ...
                  var aspectRatio =
                    (options.maintainAspectRatio && chart.aspectRatio) || null;
                  ...
                  helpers.each(
                    ...
                    function (dataset, datasetIndex) {
                      if (me.isDatasetVisible(datasetIndex)) {
                        me.getDatasetMeta(datasetIndex).controller.draw(
                          easingValue
                        );
                      }
                    },
          ...
          module.exports = function (Chart) {
            ...
            Chart.layoutService = {
              ...
              update: function (chartInstance, width, height) {
                ...
                var leftBoxes = helpers.where(chartInstance.boxes, function (
                  box
                ) {
                ...
                var topBoxes = helpers.where(chartInstance.boxes, function (
                  box
                ) {
              ...
              determineDataLimits: function () {
                ...
                helpers.each(
                  ...
                  function (dataset, datasetIndex) {
                    ...
                    var datasetVisible = me.chart.isDatasetVisible(
                      datasetIndex
                    );
