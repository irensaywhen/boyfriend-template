...
(function () {
  ...
  ((t = (function () {
    ...
    var s, i, r, n, o;
    for (n = new t(), i = 0, r = (o = e.childNodes).length; i < r; i++)
      (s = o[i]), n.add_node(s);
    return n.parsed;
  }),
    (e = (function () {
          ...
          for (
            ...
            '' !==
              (i = s.group
                ...
                : this.result_add_option(s)) && (l++, (t += i)),
        ...
        (e.prototype.winnow_results = function (e) {
          ...
          for (
            this.no_results_clear(),
              a = 0,
              t = (l = this.get_search_text()).replace(
                /[-[\]{}()*+?.,\\^$|#\s]/g,
                '\\$&'
              ),
        ...
        (e.prototype.choices_count = function () {
          ...
          for (
            this.selected_option_count = 0,
              e = 0,
              t = (s = this.form_field.options).length;
            e < t;
            e++
          )
      ...
      return (
        ...
        (r.prototype.set_up_html = function () {
          ...
          return (
            ...
            this.is_multiple
              ? ((this.search_choices = this.container.down(
                  'ul.chosen-choices'
                )),
        ...
        (r.prototype.search_field_disabled = function () {
          ...
          return (
            (this.is_disabled =
              ...
              (null != (e = this.form_field.up('fieldset'))
                ? e.disabled
                : void 0) ||
              !1),
            this.is_disabled
            ...
            return (
              ...
              null != e && e.target.hasClassName('search-choice-close')
                ...
                : (this.active_field
                    ? this.is_multiple ||
                      !e ||
                      (e.target !== this.selected_item &&
                        !e.target.up('a.chosen-single')) ||
                      this.results_toggle()
        ...
        (r.prototype.set_label_behavior = function () {
          if (
            ...
            return this.form_field_label.observe(
              'click',
        ...
        (r.prototype.search_results_mouseup = function (e) {
          var t;
          if (
            (t = e.target.hasClassName('active-result')
              ? e.target
              : e.target.up('.active-result'))
          )
            return (
        ...
        (r.prototype.search_results_mouseout = function (e) {
          if (
            e.target.hasClassName('active-result') ||
            e.target.up('.active-result')
          )
            ...
            return (
              ...
              this.max_selected_options <= this.choices_count()
                ...
                : (this.is_multiple
                  ...
                  (s = this.results_data[
                    t.getAttribute('data-option-array-index')
                  ]),
                  (s.selected = !0),
        ...
        (r.prototype.winnow_results_set_highlight = function () {
          ...
          if (
            (this.is_multiple ||
              (e = this.search_results.down('.result-selected.active-result')),
        ...
        (r.prototype.no_results_clear = function () {
          ...
          for (
            e = null, t = [];
            (e = this.search_results.down('.no-results'));
