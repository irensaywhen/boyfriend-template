...
var SearchProfilesForm = /*#__PURE__*/function (_Form) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(SearchProfilesForm, _Form);
  ...
  function SearchProfilesForm(options) {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, SearchProfilesForm);

    _this = _super.call(this, options); //Binding context

    _this.generateAgeRange = _this.generateAgeRange.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.initializeSlider = _this.initializeSlider.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.showProfile = _this.showProfile.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    _this.makeProfilesRequest = _this.makeProfilesRequest.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(SearchProfilesForm, [{
    key: "cacheElements",
    value: function cacheElements() {
      _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_8___default()(SearchProfilesForm.prototype), "cacheElements", this).call(this);
    ...
    value: function setUpEventListeners() {
      ...
      _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_8___default()(SearchProfilesForm.prototype), "setUpEventListeners", this).call(this);
      ...
      this.$form.on("inputFinished", function (event) {
        ...
        _this2.$formLoadingIndicator.fadeIn(200);

        _this2.collectFormInputs();

        var request = _this2.requests.profiles;
        ...
        _this2.makeRequest({
          ...
          _this2.$formLoadingIndicator.fadeOut(200);
          ...
          var profiles = response.profiles; // Sort profiles
    ...
    key: "makeProfilesRequest",
    value: function () {
      var _makeProfilesRequest = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
      ...
      function makeProfilesRequest() {
        return _makeProfilesRequest.apply(this, arguments);
      }

      return makeProfilesRequest;
    }()
  }, {
